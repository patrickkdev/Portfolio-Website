      ...
      <ImageSplitFeatureSection
        ...
        description={
          <p className='mt-6 text-lg text-primary opacity-80 whitespace-pre-line text-pretty leading-8'>
            ...
            Atuo de segunda a sexta, das 9h às 17h (GMT-3). Nesse período costumo responder rápido. Fora dele, fico disponível apenas em situações importantes ou combinadas anteriormente, para manter o ritmo sustentável e previsível. <br /><br />
          </p>
        }
