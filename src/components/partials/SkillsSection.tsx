  ...
  return (
    <div className="space-y-16">
      ...
      <ImageSplitFeatureSection
        ...
        description={<p className='mt-6 text-lg text-primary opacity-80 whitespace-pre-line'>Tenho experiência sólida com <ExternalLink href={ExternalLinks.react}>React</ExternalLink> e <ExternalLink href={ExternalLinks.nextjs}>Next.js</ExternalLink>. <br /><br />
