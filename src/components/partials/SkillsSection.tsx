  ...
  return (
    <div className="space-y-12 lg:space-y-16">
      ...
      <ImageSplitFeatureSection
        ...
        description={<p className='mt-6 lg:mt-4 lg:text-lg text-primary opacity-80 whitespace-pre-line text-pretty leading-8'>Tenho experiência sólida com <ExternalLink href={ExternalLinks.react}>React</ExternalLink> e <ExternalLink href={ExternalLinks.nextjs}>Next.js</ExternalLink>. <br /><br />
