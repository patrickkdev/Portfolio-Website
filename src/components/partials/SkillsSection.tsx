  ...
  return (
    <div className="space-y-12 lg:space-y-16">
      ...
      <ImageSplitFeatureSection
        title="Go e Echo"
        description={
          <p className='mt-6 lg:mt-4 text-md lg:text-lg text-primary opacity-90 whitespace-pre-line text-pretty leading-6 lg:leading-8'>
      ...
      <ImageSplitFeatureSection
        ...
        description={<p className='mt-6 lg:mt-4 text-md lg:text-lg text-primary opacity-90 whitespace-pre-line text-pretty leading-6 lg:leading-8'>Tenho experiência sólida com <ExternalLink href={ExternalLinks.react}>React</ExternalLink> e <ExternalLink href={ExternalLinks.nextjs}>Next.js</ExternalLink>. <br /><br />
        ...
        Como nem todo sistema precisa de um <ExternalLink href={ExternalLinks.spa}>SPA</ExternalLink> robusto. Para projetos onde a simplicidade reina, deixo o React de lado e escolho uma stack mais minimalista.</p>}
