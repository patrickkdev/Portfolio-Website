...
export const experiences: Experience[] = [
  {
    ...
    company: 'Sinaionline Sistemas',
    startDate: 'Fev 2024',
    endDate: 'Presente',
    description: `
Responsável pelo ciclo completo de mais de 30 sites para imobiliárias, cuidando de tudo desde o design e a arquitetura até o desenvolvimento e a hospedagem. Esses sites são implementados em React (Next.js) e chegam a atingir 100% em performance, SEO, boas práticas e acessibilidade em benchmarks como PageSpeed. Os sites consomem uma API interna que criei do zero em Golang, e mantenho com foco em segurança, confiabilidade, performance e escalabilidade.
Desenvolvi do zero e mantenho também a versão web do sistema que as imobiliárias usam para gerenciar imóveis, leads, clientes, blogs, landing pages e funcionários. É um produto de alta performance desenvolvido com uma stack moderna que combina Go, Echo, Templ e HTMX. Ele oferece recursos intuitivos como drag and drop, infinite scroll, fluxo estilo kanban, visualização avançada de imóveis com zoom e pan e outras funcionalidades que facilitam o dia a dia. Também integrei IA para gerar automaticamente descrições de imóveis.
